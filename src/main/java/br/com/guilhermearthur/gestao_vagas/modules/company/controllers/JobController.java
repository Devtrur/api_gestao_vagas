package br.com.guilhermearthur.gestao_vagas.modules.company.controllers;
...
import br.com.guilhermearthur.gestao_vagas.modules.company.dto.CreateJobDTO;
import br.com.guilhermearthur.gestao_vagas.modules.company.entities.JobEntity;
import br.com.guilhermearthur.gestao_vagas.modules.company.useCases.CreateJobUseCase;
import br.com.guilhermearthur.gestao_vagas.modules.company.useCases.ListAllJobsByCompanyUseCase;
...
public class JobController {
    ...
    @Operation(summary = "Listagem de vagas", description = "Esta funcao e responsavel por listar as vagas dentro da empresa")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Lista de vagas retornada com sucesso", content = @Content(schema = @Schema(implementation = JobEntity.class)))
    })
    @SecurityRequirement(name = "jwt_auth")
