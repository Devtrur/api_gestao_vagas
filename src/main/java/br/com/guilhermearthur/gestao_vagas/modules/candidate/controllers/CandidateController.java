package br.com.guilhermearthur.gestao_vagas.modules.candidate.controllers;
...
import br.com.guilhermearthur.gestao_vagas.modules.candidate.dto.ProfileCandidateResponseDTO;
import br.com.guilhermearthur.gestao_vagas.modules.candidate.useCase.ApplyJobCandidateUseCase;
import br.com.guilhermearthur.gestao_vagas.modules.candidate.useCase.CreateCandidateUseCase;
import br.com.guilhermearthur.gestao_vagas.modules.candidate.useCase.ListAllJobsByFilterUseCase;
import br.com.guilhermearthur.gestao_vagas.modules.candidate.useCase.ProfileCandidateUseCase;
...
@Tag(name = "Candidato", description = "Info Candidatos")
public class CandidateController {
    ...
    @PostMapping("/")
    @Operation(summary = "Cadastro do candidato", description = "Essa funcao e responsavel por cadastrar um candidato")
    @ApiResponses({
    ...
    @Operation(summary = "Perfil do candidato", description = "Esta funcao e responsavel por buscar as informacoes do perfil do candidato")
    @ApiResponses({
    ...
    @PreAuthorize("hasRole('CANDIDATE')")
    @Operation(summary = "Inscricao do candidato para uma vaga", description = "Esta funcao e responsavel por realizar a inscricao do candidato em uma vaga.")
    @SecurityRequirement(name = "jwt_auth")
